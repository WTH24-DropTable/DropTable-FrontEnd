  ...
  return (
    <>
        ...
        <div className="min-h-screen bg-black text-white font-barlow p-6">
          <h1 className="text-4xl font-bold text-lblue my-8">Welcome, Donovan Koh</h1>

          <div className="flex mt-6">
            {/* Classes Section */}
            <div className="w-1/4 mr-6">
              <h2 className="text-xl font-semibold text-lblue mb-4">Classes</h2>
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold text-lblue mb-4">
